...
int convolve(matrix_t *a_matrix, matrix_t *b_matrix, matrix_t **output_matrix) {
  ...
  *output_matrix = (matrix_t*)malloc(sizeof(matrix_t));
  ...
  // Saves vectors with b matrix data for cache optimization
  ...
  // Outer Loops for holding current position in output matrix
  ...
  for (int i=0; i < rows_bound; i++) {
	  ...
	  // Inner Loops do computations for output matrix
